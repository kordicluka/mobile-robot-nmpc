...
Razvoj algoritama za planiranje putanje mobilnih robota traje desetljećima. Najraniji pristupi temelje se na pretraživanju grafova u diskretiziranom prostoru. Dijkstrin algoritam garantira optimalnost ali ne koristi heurističku informaciju o cilju. \textbf{A* algoritam} \cite{hart1968astar}, uveden 1968.\ godine, dodaje procjenu preostale udaljenosti do cilja --- ravnu liniju do cilja --- i time značajno ubrzava pretraživanje uz zadržavanje optimalnosti na diskretnoj rešetki \cite{lavalle2006planning}. A* je u širokoj primjeni, među ostalim u ROS-u (eng.\ \textit{Robot Operating System}), standardnoj platformi istraživačke robotike.
...
Za praćenje generirane putanje postoje razni pristupi --- geometrijski regulatori (Pure Pursuit \cite{coulter1992purepursuit}, Stanley), PID-regulatori i LQR. Svi su relativno jednostavni za implementaciju, ali zajednički im je nedostatak: ne gledaju unaprijed i ne uzimaju u obzir ograničenja sustava na formalan način.

\textbf{Modelsko prediktivno upravljanje} (eng.\ \textit{Model Predictive Control}, MPC) \cite{rawlings2017mpc, borrelli2017predictive} rješava upravo to: na svakom koraku gleda unaprijed kroz cijeli predikcijski horizont i optimizira upravljanje uz eksplicitno poštivanje svih ograničenja. \textbf{Nelinearni MPC} (NMPC) proširuje taj pristup na nelinearne sustave poput monocikla. U ovom radu implementirano je korištenjem alata acados \cite{verschueren2022acados, acados_docs}.
...
\begin{enumerate}
  \item Prošireni model monocikla u kojemu su ubrzanja ($a_v$, $\alpha$) upravljačke veličine, što olakšava postavljanje ograničenja u NMPC-u
  \item Meka ograničenja izbjegavanja prepreka koja penaliziraju približavanje preprekama, ali ne uzrokuju neriješivost optimizacijskog problema
