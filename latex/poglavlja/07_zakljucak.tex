...
\begin{enumerate}
  ...
  \item \textbf{Contouring MPC:} varijanta NMPC-a koja kažnjava bočno odstupanje i brzinu napredovanja po putanji umjesto praćenja diskretnih referentnih točaka~\cite{cmpc}
